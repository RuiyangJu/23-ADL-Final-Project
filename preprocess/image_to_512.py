...
def main(argv=None):
    ...
    image_save_dir = ['../data/Trainset_image_512/Trainset/image/', '../data/Testset_image_512/Testset/image/']
    mask_save_dir = ['../data/Trainset_mask_512/Trainset/mask/', '../data/Testset_image_512/Testset/mask/']
